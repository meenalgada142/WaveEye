...
| [`axil_ram`](alex_forencich_axil_ram/terminal_output.txt) | `axil_ram.v` | 56 | `AXI4L_WRITE_RESPONSE_MISSING` | Always-block NBA override on RVALID — asserting assignment overwritten; 4 violation types detected | 1.5 s |
